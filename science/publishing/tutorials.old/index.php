...
$APPLICATION->SetTitle("Учебники и рекомендации");
?><?$APPLICATION->IncludeComponent("bitrix:news", "publishing_tutorials", Array(
	"IBLOCK_TYPE" => "dynamic_content",	// Тип инфоблока
		...
		"SORT_BY1" => "PROPERTY_YEAR",	// Поле для первой сортировки новостей
		...
		"SEF_FOLDER" => "/science/publishing/tutorials/",	// Каталог ЧПУ (относительно корня сайта)
