...
if(sizeof($arIds) > 0)
{
    ...
    while($arItem = $rsFile->GetNext())
    {
        ...
        $urlPreviewPicture = itc\Resizer::get($arItem["ID"], 'height', null, 234, $extension);
...
// добавить заглушки
$urlNoDetailPicture = itc\Resizer::get(NO_PHOTO_ID, 'height', null, 234, NO_PHOTO_EXTENSION);
